          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {isProduction 
                  ? 'Sign in with your Google account to access TeamHub'
                  : 'Sign in or create an account to access TeamHub'}
              </p>
            </div>
            
            <div className="flex flex-col gap-3 max-w-sm mx-auto">
              {isProduction ? (
                // Production: Show only Google login
                <Button 
                  size="lg" 
                  variant="outline"
                ...
                // Development: Show only email/password options
                <>
                  <Button 
                    size="lg" 
